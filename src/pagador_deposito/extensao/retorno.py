...
class CheckoutPayment(EntidadeSerializavel):
    atributos = [Atributo("USER"), Atributo("PWD"), Atributo("SIGNATURE"), ]
...
class Registro(RegistroBase):
    ...
    @property
    def url(self):
        return "https://api-3t.{}paypal.com/nvp".format("sandbox." if settings.DEBUG else "")
